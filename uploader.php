                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-2"><input class="btn  btn-fill pull-left" type="button" value="Save Channel" onclick="saveLoanChannel()"></div>      
                                                </div>
                                            </div>
                                            <br>
                                            <br>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <br>
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-3"><input class="btn  btn-fill pull-left" type="button" value="Save Account" onclick="addupdate()"></div>      
                                                </div>
                                            </div>
